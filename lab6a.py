...
class Student:
    ...
    def __init__(self, name, number):
        self.name = name
        self.number = str(number)  # Convert number to string to avoid type issues
        self.courses = {}
    ...
    def displayGPA(self):
        if len(self.courses) == 0:
            return f'GPA of student {self.name} is 0.0'  # Updated to match expected test output
    ...
    def displayCourses(self):
        ...
        return passed_courses  # Always return a list, even if it's empty
